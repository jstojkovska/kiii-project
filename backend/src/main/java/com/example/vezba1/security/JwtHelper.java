...
public class JwtHelper {
    ...
    public JwtHelper(JwtTokenLogRepository jwtTokenLogRepository) {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        jwtTokenLog.setUsername(userDetails.getUsername());
        jwtTokenLog.setToken(token);
        jwtTokenLog.setIssuedAt(new Date(System.currentTimeMillis()));
        jwtTokenLog.setExpiresAt(new Date(System.currentTimeMillis() + JwtConstants.EXPIRATION_TIME));
