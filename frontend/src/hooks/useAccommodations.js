...
const useAccommodations = () => {
    ...
    const onToggleRented=useCallback((id)=>{
        accommodationRepository
            .toggleRented(id)
            .then(()=>{
                console.log("Successfully change the rent")
                fetchAccommodations()
            })
    },[fetchAccommodations])
    ...
    return {...state, onAdd: onAdd, onEdit: onEdit, onDelete: onDelete,onToggleRented:onToggleRented};
};
